...
export default {
  ...
  editProfileForm: {
    ...
    phoneVisibilityNote:
      "شماره تلفن شما برای برقراری ارتباط مستقیم جهت هماهنگی‌های ارسال بسته، برای سایر کاربران قابل مشاهده خواد بود.",
  },
  formErrors: {
  ...
  landing: {
    hero: {
      title: "ارتباط مسافران با فرستندگان بسته",
      description:
    ...
    benefits: {
      ...
      description:
        "چه مسافری باشید که به دنبال کسب درآمد اضافی هستید و چه فرستنده که نیاز به ارسال بسته دارد، اربیت‌پکس آن را ساده، امن و مقرون به صرفه می‌کند.",
      items: {
        forTravelers: {
          name: "برای مسافران",
          description:
        ...
        forSenders: {
          name: "برای فرستندگان",
          description:
            "مسافران معتمد که به مقصد بسته شما می‌روند را پیدا کنید. تحویل سریع و مقرون به صرفه.",
        },
        safeAndSecure: {
          name: "امن و مطمئن",
          description:
    ...
    cta: {
      ...
      description:
        "از اولین کاربران ما باشید که از پلتفرم ما بهره می‌برند. چه مسافر باشید و چه فرستنده، اربیت‌پکس آن را ممکن می‌سازد.",
      getStarted: "شروع کنید",
  ...
  how_it_works: {
    ...
    intro:
      "پلتفرم ما مسافران و فرستندگان را برای تحویل بسته‌ها به هم متصل می‌کنه. نقش خودتون رو انتخاب کنید و سفر خود را آغاز کنید.",
    for_senders: {
      title: "برای فرستندگان",
      description:
        "لیست مسافران را مرور کنید تا کسی را پیدا کنید که بتواند بسته شما را تحویل دهد، یا جزئیات بسته خود را ثبت کنید و منتظر بمانید تا مسافری با شما تماس بگیرد.",
    },
    for_travelers: {
      title: "برای مسافران",
      description:
        "برنامه سفر خود را ثبت کنید و منتظر بمانید تا فرستندگان با شما تماس بگیرند، یا بسته‌های موجود را مرور کنید و با فرستندگان هماهنگ کنید.",
    },
    safety_tips: {
      title: "نکات ایمنی",
      description:
        "برای امنیت، فقط بسته‌هایی را بپذیرید که قابل بررسی باشند. ما توصیه می‌کنیم مدارک یا خریدهایی که خودتان انجام می‌دهید را تحویل بگیرید و هزینه آن را دریافت کنید.",
    },
  } as const,
} as const;
